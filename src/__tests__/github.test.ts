...
describe('GitHub Module', () => {
  ...
  describe('listOpenPRs', () => {
    it('should return empty array when no PRs are found', async () => {
      ...
      expect(mockExecAsync).toHaveBeenCalledWith('gh pr list --state open --json number,title,headRefName,author,isDraft');
    });
    ...
    it('should handle GitHub CLI errors', async () => {
      ...
      await expect(listOpenPRs(mockLogger, false, mockExecAsync))
